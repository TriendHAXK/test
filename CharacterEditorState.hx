...
class CharacterEditorState extends MusicBeatState
{
	...
	function addCharacterUI() {
		...
		tab_group.add(new FlxText(15, imageInputText.y - 18, 0, 'Image file name:kiss'));
		tab_group.add(new FlxText(15, healthIconInputText.y - 18, 0, 'Health icon name:kiss'));
		tab_group.add(new FlxText(15, singDurationStepper.y - 18, 0, 'Sing Animation length:kiss'));
